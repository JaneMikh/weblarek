...
Свойства:
- Хранение массива товаров, добавленных покупателем в корзину.
...
Класс Buyer предназначен для хранения информации о покупателе, необъодимой для оформления заказа.
